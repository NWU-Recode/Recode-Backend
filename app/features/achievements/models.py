...
class UserElo(Base):
    ...
    user_id = Column(Integer, ForeignKey("profiles.id", ondelete="CASCADE"))  # Changed to Integer to match profiles.id
...
class UserBadge(Base):
    ...
    user_id = Column(Integer, ForeignKey("profiles.id", ondelete="CASCADE"), primary_key=True)  # Changed to Integer to match profiles.id
